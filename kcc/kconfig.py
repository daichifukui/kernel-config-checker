...
from .defaults import MUST_BE_SET, MUST_BE_SET_OR_MODULE, MUST_BE_UNSET, MUST_BE_MODULE
...
class Kconfig(object):
    ...
    def check_line(self, line: str) -> Dict[str, str]:
        ...
        if match:
            ...
            if notset in self.must_be_module:
                return {notset: self.N_MUST_M % \
                        ('', self.must_be_module[notset])}
